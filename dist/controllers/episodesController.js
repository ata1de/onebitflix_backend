...
const episodeServiceUrl_1 = require("../services/episodeServiceUrl");
exports.episodesController = {
    ...
    stream: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            episodeServiceUrl_1.episodeService.streamEpisodeToResponse(res, videoUrl, range);
        }
        catch (err) {
    ...
    getWatchTime: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const watchTime = yield episodeServiceUrl_1.episodeService.getWatchTime(userId, Number(episodeId));
    ...
    setWatchTime: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const watchTime = yield episodeServiceUrl_1.episodeService.setWatchTime({
                episodeId,
                userId,
                seconds
            });
